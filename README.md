...
This could, for example, be checked when parsing the json if we enforce a rule saying that in the `dependsOn` list of a container, can only contain containers previously declared in the file.
